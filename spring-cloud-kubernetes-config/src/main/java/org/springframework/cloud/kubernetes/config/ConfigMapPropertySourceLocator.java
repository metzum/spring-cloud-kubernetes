...
public class ConfigMapPropertySourceLocator implements PropertySourceLocator {
	...
	public PropertySource locate(Environment environment) {
		if (environment instanceof ConfigurableEnvironment) {
			...
			if (this.properties.isEnableApi()) {
				sources.forEach(s -> getMapPropertySourcesForConfigMaps(env, s)
						.forEach(composite::addFirstPropertySource));
			}
	...
	private List<? extends MapPropertySource> getMapPropertySourcesForConfigMaps(
		...
		if (normalizedSource.getLabelName() == null) {
			...
			return ConfigMapPropertySource.getPropertySourceList(this.client,
					normalizedSource.getLabelName(), normalizedSource.getLabelValue(),
					normalizedSource.getName(), getApplicationNamespace(this.client,
							normalizedSource.getNamespace(), configurationTarget),
					environment);
		}
	}
